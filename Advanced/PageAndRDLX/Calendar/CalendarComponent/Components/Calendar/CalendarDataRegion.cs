...
namespace ActiveReports.Calendar.Components.Calendar
{
	...
	public sealed class CalendarDataRegion : DataRegionBase, ICalendar, ICustomReportItem, IFixedSizeItem, IReportItemRenderersFactory
	{
        ...
        /// </summary>
        GrapeCity.ActiveReports.Drawing.FontStyle ActiveReports.Calendar.Components.Calendar.ICalendar.MonthTitleFontStyle
		{
			get
			{
		...
		Collection<Appointment> ICalendar.Appointments
		{
			get
			{
				if (_appointments == null)
				{
					...
					if (CustomData != null)
					{
                        GrapeCity.ActiveReports.Extensibility.Rendering.DataGroupingCollection appointmentsData = CustomData.DataRowGroupings;
