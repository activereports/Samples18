...
using ExpressionInfoUITypeEditor = GrapeCity.ActiveReports.Design.DdrDesigner.Tools.ExpressionInfoUITypeEditor;
using ToolsNamespace = ActiveReports.Calendar.Design.Tools;
		...
		internal sealed class Converter : RootExpandableConverter
		{
			...
			public override object ConvertFrom(ITypeDescriptorContext context, CultureInfo culture, object value)
			{
				if (value is string)
				{
					...
					return new FillerDayStyle(
						(ExpressionInfo)new Converters.ColorExpressionInfoConverter().ConvertFrom(context, culture, colorString),
			...
			public override PropertyDescriptorCollection GetProperties(ITypeDescriptorContext context, object value, Attribute[] attributes)
			{
				...
				properties[0] = new ShadowProperty(
					...
					new TypeConverterAttribute(typeof(Converters.ColorExpressionInfoConverter)),
