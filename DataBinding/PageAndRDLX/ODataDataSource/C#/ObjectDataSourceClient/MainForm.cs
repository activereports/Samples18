using ActiveReports.Samples.ObjectDataSource.Models;
...
namespace ActiveReports.Samples.ODataDataSource
{
	...
	public partial class MainForm : Form
	{
		...
		{
			InitializeComponent();
			var container = new ActiveReports.Samples.ObjectDataSource.Default.Container(new Uri(serviceUri));
			_dataList = GetYears(container);
		}

		private IList<Year> GetYears(ActiveReports.Samples.ObjectDataSource.Default.Container container)
		{
